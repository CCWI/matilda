...
@ComponentScan("edu.hm.ccwi.matilda.gateway")
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {// @formatter:off
		http.csrf().disable()
				// .authorizeRequests().and().authenticationEntryPoint(restAuthenticationEntryPoint)
				.authorizeRequests()
	...
	@Bean
	public RestTemplate gwRestTemplate(RestTemplateBuilder builder) {
